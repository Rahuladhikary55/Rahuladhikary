...
class Config(object):
    ...
    BOT_TOKEN = os.getenv("BOT_TOKEN", "5603421794:AAEB5ZC_MuSKLcMoUpH-Ko2AL37Q6wQZmdM")
    BOT_SESSION_NAME = os.getenv("BOT_SESSION_NAME", "Mdiskrahulbot")
    ...
    BOT_USERNAME = os.getenv("BOT_USERNAME", "Mdisksearch1_robot")
