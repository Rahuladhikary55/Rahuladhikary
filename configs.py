...
class Config(object):
    ...
    BOT_TOKEN = os.getenv("BOT_TOKEN", "5816377894:AAFyVLrnUY3oTJ302AhGBwvvA1YMQBaTOdQ")
    BOT_SESSION_NAME = os.getenv("BOT_SESSION_NAME", "crazybot")
    ...
    BOT_USERNAME = os.getenv("BOT_USERNAME", "orginalCrazy_Bot")
    BOT_OWNER = int(os.getenv("BOT_OWNER", "1508571231"))
#    OWNER_USERNAME = os.getenv("OWNER_USERNAME", "Rahulofficial5")
...
ꜰᴏʀ ᴍᴏʀᴇ ɪɴꜰᴏ ᴄʟɪᴄᴋ ᴏɴ ʜᴇʟᴘ ✅""" )
    UPDATES_CHANNEL = os.getenv("UPDATES_CHANNEL", " -1001792838010")
    ...
    UPDATES_CHANNEL_USERNAME = os.getenv("UPDATES_CHANNEL_USERNAME", "movierahul")
